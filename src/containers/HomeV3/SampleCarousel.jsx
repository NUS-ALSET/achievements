    ...
    return (
      <Carousel
        ...
        renderCenterLeftControls={({ currentSlide, goToSlide }) => {
          const previousSlideIndex = (currentSlide - itemPerSlide)>0 ?  currentSlide - itemPerSlide : 0;
          return  <Button
            variant="fab"
            mini
        ...
        renderCenterRightControls={({ currentSlide, goToSlide }) => {
          const nextSlideIndex = (currentSlide + itemPerSlide) <= dataList.length ?  currentSlide + itemPerSlide : dataList.length;
          return <Button
            variant="fab"
            mini
            aria-label="nexSlide"
