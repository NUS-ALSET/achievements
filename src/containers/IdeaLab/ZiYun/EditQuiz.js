...
class EditQuiz extends Component {
  ...
  editOpt = (type, i, j, event) => {
    // i=index of question obj, j=index of option in array
    event.persist();
    if (type === "new") {
      this.setState(state => {
  ...
  render() {
    return (
      <Fragment>
        ...
        >
          <Grid item xs={10}>
            <Typography variant={"h6"}>
              This is in edit view. Only content creators should be able to see
              this.
            </Typography>
          </Grid>
          <Grid item xs={2}>
        ...
        <div>
          <StyledButton onClick={this.addQues}>Add Question</StyledButton>

          <StyledButton
            style={{ width: 100 }}
            onClick={() => {
              this.props.saved(this.state.prevQuestions, this.state.questions);
            }}
          >
            Save
          </StyledButton>
  ...
  return (
    <div>
      <TextField
        ...
        onChange={e => {
          props.editQuest(props.type, props.index, e);
        }}
      />
      ...
      <Button
        ...
        onClick={() => {
          props.removeQues(props.type, props.index);
        }}
      >
        Remove Question
      </Button>
        ...
        return (
          <div key={i}>
            <TextField
              ...
              value={obj}
              onChange={e => {
                props.editOpt(props.type, props.index, i, e);
              }}
            />
            ...
            {props.options.length === i + 1 && (
              <Button
                style={{ marginTop: 20, fontSize: 24, padding: 0 }}
                onClick={e => {
                  props.addOption(props.type, props.index);
                }}
              >
                +
              </Button>
    ...
    return (
      <FormControl style={{ paddingTop: 30 }}>
        ...
        <RadioGroup
          ...
          onChange={e =>
            this.props.setCorrect(this.props.type, this.props.index, e)
          }
        >
