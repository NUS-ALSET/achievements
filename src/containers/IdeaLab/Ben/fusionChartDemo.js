...
class fusionChartDemo extends React.PureComponent {
  ...
  updateActIndex = increment => () => {
    ...
    const actIndex =
      newIndex < 0
        ? myDataSource.categories[0].category.length - 1
        : newIndex >= myDataSource.categories[0].category.length
        ? 0
        : newIndex;
    this.setState({
      actIndex
    ...
    return (
      <Fragment>
        <Typography variant="h5">
          This page will be shown after user click on the "Analytics" button in
              ...
              dataset: [
                {
                  ...
                  data: [myDataSource.dataset[0].data[this.state.actIndex]]
                }
              ]
            }
          }}
  ...
  dataset: [
    {
      ...
      data: [
        ...
        },
        {
          ...
          outliers: calcOutlier(
            [23, 25, 21, 32, 36, 29, 31, 29, 29, 46],
            "outlier"
          )
        },
        {
          value: calcOutlier(
            [60, 70, 67, 65, 80, 66, 62, 22, 120, 100],
            "value"
          ),
          outliers: calcOutlier(
            [60, 70, 67, 65, 80, 66, 62, 22, 120, 100],
        ...
        },
        {
          ...
          outliers: calcOutlier(
            [55, 57, 59, 59, 42, 47, 42, 45, 60, 59],
            "outlier"
          )
        },
        {
          value: calcOutlier(
            [70, 77, 79, 89, 72, 87, 72, 75, 20, 120],
            "value"
          ),
          outliers: calcOutlier(
            [70, 77, 79, 89, 72, 87, 72, 75, 20, 120],
...
const chartConfigs = {
  // chartConfig is for the first main chart you see
  type: "boxandwhisker2d",
  width: "100%",
  height: 500,
  dataFormat: "json",
...
export default fusionChartDemo;
