...
class LogCustomAnalysis extends React.PureComponent {
  static propTypes = {
  ...
  isValid = () => {
    ...
    switch (this.state.type) {
      case "Path":
        check = this.state.pathID && this.state.analysisID ? true : false;
        break;
      case "Course":
        check = this.state.courseID && this.state.analysisID ? true : false;
        break;
      default:
        check = false;
        break;
