...
function App() {
  const gameData = {
    playMode:
      getURLParameters("mode") === "manual" ? "manual code" : "custom code",
    ...
    <div>
      ...
      <div className="info">
        ...
        <a
          ...
          }/?mode=manual&level=2&gameTime=200&botsQuantities=5&scoreToWin=35`}
        >{`${
          window.location.origin
        }/?mode=manual&level=2&gameTime=200&botsQuantities=5&scoreToWin=35`}</a>
      </div>
    </div>
  );
}
