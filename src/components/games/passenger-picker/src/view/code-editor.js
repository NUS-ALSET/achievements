      ...
      <div className="editor-container">
        <div className="editor-control">
          <div>
            <h4>
              Write{" "}
              <b className="active-text">{Store.editorMode.toUpperCase()}</b>{" "}
              Code Here :{" "}
            </h4>
            <h5>
              <strong>Note : </strong>h5lease do not change the name of the
              function <strong>getPlayersCommands(world)</strong> & function
              must return one of these direction (LEFT, RIGHT, UP, DOWN)
            </h5>
          </div>
          <div className="btn-group">
            <button
              type="button"
              className="btn half active"
              id="run"
              onClick={this.handleCodeExecution}
            >
              Update Solution
            </button>
            <button
              type="button"
              className="btn half reset"
              onClick={this.resetDefaultCode}
            >
              Reset Solution
            </button>
          </div>
