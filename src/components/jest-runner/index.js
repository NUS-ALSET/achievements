                    ...
                    {files.length > 0 &&
                        <div className="mainWrap" id="editor-panel">
                            ...
                            <div className="container" id="container">
                                <FileDirectory files={files} openFile={this.openFile} selectedFile={selectedFile} />
                                <Editor readOnly={readOnly} saveFile={this.saveFile} selectedFile={selectedFile} />
                            </div>

                           <div style={{ height: "97px" }}>
                                <p className="note">Note :Only files with <span  aria-label={"Editble"} role="img">✅</span> icon are editable.</p>
                                {!readOnly &&
