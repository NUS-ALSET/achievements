    ...
    render() {
        return (
            <div className="editor">
                <button className="save-btn" onClick={()=>this.props.saveFile(this.props.selectedFile, this.state.code)} style={{ right :this.props.selectedFile.code===this.state.code ? "-250px" : "0px" }}>Save File</button>
                <AceEditor
